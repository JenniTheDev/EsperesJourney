...
public class PlayerInput : MonoBehaviour {
    ...
    */
    ...
    [SerializeField] private PlayerController playerScript;  // This references the script on the player object we need to access

    [SerializeField] private Player Player;                  // This references the input action map
    [SerializeField] private GameObject _Player;            // This references the player gameObject in the scene
